...
~/.fzf/install
echo '[!] please manually install node'
echo '[!] please run `sudo apt-get update`'
echo '[!] please run `sudo apt-get install ripgrep`'
echo '[!] please run `sudo apt install clang`'
echo '[!] please run `sudo apt install unzip`'
